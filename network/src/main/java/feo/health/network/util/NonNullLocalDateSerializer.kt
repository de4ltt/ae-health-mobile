...
/**
 * Serializer for non-null [LocalDate] using standard ISO format (e.g. YYYY-MM-DD).
 */
object NonNullLocalDateSerializer : KSerializer<LocalDate> {
    /**
    ...
    /**
     * Encodes a non-null [LocalDate] instance into string form.
     *
    ...
    /**
     * Decodes a string representing ISO date to non-null [LocalDate] instance.
     *
     * @param decoder Serial input decoder context.
     * @return Decoded [LocalDate] instance.
     */
